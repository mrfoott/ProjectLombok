...
//    BeerController beerController;
    ...
    void setUp() {
        ...
        beer = (BeerDTO) beerServiceImpl.listBeers(null, null, false, 1, 50).getContent().get(0);
    }
...
//    }
    ...
    void getBeerListNotFound() throws Exception {
        given(beerService.listBeers(any(), any(), any(), any(), any())).willThrow(NotFoundException.class);
